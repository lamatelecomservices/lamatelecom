...
export const ABOUT_LEADERSHIP_TEAM: LeadershipMember[] = [
  ...
  },
  {
    ...
    bio: "Yangchen Dolkar is a strategic business operations leader with over 15 years of experience building and scaling enterprise-ready systems across technology, logistics, and data center environments.\n\nAt Lama Telecom Services, she supports operational strategy, process optimization, and growth initiatives—helping strengthen execution, compliance, and scalable business performance.",
  },
  {
    id: "eric-savoia",
    indexLabel: "06",
    name: "Eric Savoia",
    title: "Head of Asset Recovery Operations (ARO Lead)",
